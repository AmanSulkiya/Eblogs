<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href="#"><i class="fa fa-file fa-spin"
		aria-hidden="true"></i> E-Blogs</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="addBlog.jsp"><i
					class="fa fa-plus-circle" aria-hidden="true"></i> Add Blogs</a></li>

<li class="nav-item"><a class="nav-link" href="index.jsp"><i class="fa fa-refresh" aria-hidden="true"></i> Refresh</a></li>

			<li class="nav-item"><a class="nav-link" href="showBlog.jsp"><i
					class="fa fa-address-book-o" aria-hidden="true"></i> Show Blogs</a></li>
		</ul>
